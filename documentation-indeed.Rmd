...
To answer this question, the researchers collected and analyzed job listings from [Indeed.com](https://nl.indeed.com/?r=us). This is a worldwide employment website for job listings. Currently, it is the market-leader within the Dutch labor market (source 1). The central focus was placed on the job listings belonging to the search terms 'Data Analist', 'Data Scientist', 'Marketing Analist' and 'Marketeer' with the location 'Nederland', to make the data as useful as possible for Marketing Analytics students.
...
No, it is not possible to identify individuals directly or indirectly.
...
No, the datasets do not contain sensitive data.
...
To collect the data we used Python and multiple Python packages to create a webscraper. The webscraper was manually curated by the 4 students named earlier. Furthermore we used a Github repository to keep track of our project.
...
No, there has not been an ethical review process conducted by a review board.
...
The datasets have only been used for the course Data Preparation and Workflow Management that is part of the MSc Marketing Analytics at Tilburg University.
...
No, there is nothing in the datasets that might impact future use.
