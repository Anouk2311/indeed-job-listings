...
To collect the data we used Python and multiple Python packages to create a webscraper. ![Scraper alternatives](https://github.com/Anouk2311/indeed-job-listings/blob/main/docs/scraper_alternatives.jpg) The webscraper was manually curated by the 4 students named earlier.
...
Yes preprocessing has taken place in order to merge the descriptions and the listing CSV files together by id, into 1 CSV per job title. This preprocessing has been done to improve the structure and the accessibility of the datasets.
