...
To collect the data we used Python and multiple Python packages to create a webscraper. ![Scraper alternatives](docs/scraper_alternatives.jpg) The webscraper was manually curated by the 4 students named earlier.
