...
pdf(here("gen". "analysis", "temp", "plot_mean_salary.pdf"))
print(plot_mean_salary)
dev.off()

pdf(here("gen". "analysis", "temp", "plot_salary.pdf"))
print(plot_salary)
dev.off()

pdf(here("gen". "analysis", "temp", "plot_location.pdf"))
print(plot_location)
dev.off()

pdf(here("gen". "analysis", "temp", "data_scientist_location_plot.pdf"))
print(data_scientist_location_plot)
dev.off()

pdf(here("gen". "analysis", "temp", "data_analist_location_plot.pdf"))
print(data_analist_location_plot)
dev.off()

pdf(here("gen". "analysis", "temp", "marketing_analist_location_plot.pdf"))
print(marketing_analist_location_plot)
dev.off()

pdf(here("gen". "analysis", "temp", "marketeer_location_plot.pdf"))
print(marketeer_location_plot)
dev.off()


pdf(here("gen". "analysis", "temp", "percentage_plot_data_scientist.pdf"))
print(percentage_plot_data_scientist)
dev.off()

pdf(here("gen". "analysis", "temp", "percentage_plot_data_analist.pdf"))
print(percentage_plot_data_analist)
dev.off()

pdf(here("gen". "analysis", "temp", "percentage_plot_marketing_analist.pdf"))
print(percentage_plot_marketing_analist)
dev.off()

pdf(here("gen". "analysis", "temp", "percentage_plot_marketeer.pdf"))
print(percentage_plot_marketeer)
dev.off()

pdf(here("gen". "analysis", "temp", "count_plot_data_scientist.pdf"))
print(count_plot_data_scientist)
dev.off()

pdf(here("gen". "analysis", "temp", "count_plot_data_analist.pdf"))
print(count_plot_data_analist)
dev.off()

pdf(here("gen". "analysis", "temp", "count_plot_marketing_analist.pdf"))
print(count_plot_marketing_analist)
dev.off()

pdf(here("gen". "analysis", "temp", "count_plot_marketeer.pdf"))
print(count_plot_marketeer)
dev.off()

pdf(here("gen". "analysis", "temp", "plot_skills.pdf"))
print(plot_skills)
dev.off()

pdf(here("gen". "analysis", "temp", "data_scientist_salary_plot.pdf"))
print(data_scientist_salary_plot)
dev.off()

pdf(here("gen". "analysis", "temp", "data_analist_salary_plot.pdf"))
print(data_analist_salary_plot)
dev.off()

pdf(here("gen". "analysis", "temp", "marketing_analist_salary_plot.pdf"))
print(marketing_analist_salary_plot)
dev.off()

pdf(here("gen". "analysis", "temp", "marketeer_salary_plot.pdf"))
