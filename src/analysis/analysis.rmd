...
Top locations for Data Scientists in terms of salary are are Amsterdam and Zaandam. In each of these places the average salary for Data Scientists is over 60000 annually, which is well above the average earnings for the entire country. 
...
For Data Analysts, again Zaandam and Amsterdam re the cities with highest average salaries. Another attractive option is Apeldoorn. These top 3 cities all have average salaries close to or even over 60000 euro's per year. Quite more than the national average. 
...
For Marketing Analysts, the best places to find a job are Amsterdam, Almere, Den Haag and Utrecht. 
```{r, echo = FALSE, warning = FALSE, fig.align = 'left'}
