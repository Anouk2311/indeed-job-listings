...
pdf(here("gen","data-preparation", "input", "data_scientist_location_plot.pdf"))
print(data_scientist_location_plot)
dev.off()

pdf(here("gen","data-preparation", "input", "data_analist_location_plot.pdf"))
print(data_analist_location_plot)
dev.off()

pdf(here("gen","data-preparation", "input", "marketing_analist_location_plot.pdf"))
print(marketing_analist_location_plot)
dev.off()

pdf(here("gen","data-preparation", "input", "marketeer_location_plot.pdf"))
print(marketeer_location_plot)
dev.off()


pdf(here("gen","data-preparation", "input", "percentage_plot_data_scientist.pdf"))
print(percentage_plot_data_scientist)
dev.off()

pdf(here("gen","data-preparation", "input", "percentage_plot_data_analist.pdf"))
print(percentage_plot_data_analist)
dev.off()

pdf(here("gen","data-preparation", "input", "percentage_plot_marketing_analist.pdf"))
print(percentage_plot_marketing_analist)
dev.off()

pdf(here("gen","data-preparation", "input", "percentage_plot_marketeer.pdf"))
print(percentage_plot_marketeer)
dev.off()

pdf(here("gen","data-preparation", "input", "count_plot_data_scientist.pdf"))
print(count_plot_data_scientist)
dev.off()

pdf(here("gen","data-preparation", "input", "count_plot_data_analist.pdf"))
print(count_plot_data_analist)
dev.off()

pdf(here("gen","data-preparation", "input", "count_plot_marketing_analist.pdf"))
print(count_plot_marketing_analist)
dev.off()

pdf(here("gen","data-preparation", "input", "count_plot_marketeer.pdf"))
print(count_plot_marketeer)
dev.off()
...
pdf(here("gen","data-preparation", "input", "data_scientist_salary_plot.pdf"))
print(data_scientist_salary_plot)
dev.off()

pdf(here("gen","data-preparation", "input", "data_analist_salary_plot.pdf"))
print(data_analist_salary_plot)
dev.off()

pdf(here("gen","data-preparation", "input", "marketing_analist_salary_plot.pdf"))
print(marketing_analist_salary_plot)
dev.off()

pdf(here("gen","data-preparation", "input", "marketeer_salary_plot.pdf"))
print(marketeer_salary_plot)
dev.off()
...
This plot shos that data sientists in general dominate salaries in each location, shortly followed by data analist and marketing analist. However, in Leiden, there seems to be a particularly attractive marketing analist position opening up. 
...
For location, Amsterdam is the clear winner when it comes to number of job offers for any of our 4 search terms. Utrecht comes in 2nd and Rotterdam, Den Haag and Eindhoven make up the top 5. The results make sense since this are also the biggest cities in terms of population within the Netherlands. The results were pretty similar for the 3 data jobs but we saw a clear difference for marketeer jobs, where relatively more opportunities were situatied outside of the Randstad in cities such as Nijmegen, Breda and Arnhem. For salary, data scientist seem to be in the best position, with on average the highest salaries compared to marketeers, data analysts and marketing analysts. 
